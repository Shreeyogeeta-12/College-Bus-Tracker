...
const ROUTE_STOPS = {
  ...
  m730_b5:  ["KLS GIT", "Ganesh Temple", "Kuvempu Nagar", "KLE School", "Sahaydri Nagar", "Kumarswamy Layout", "Hostel","Hanuman Nagar 2nd Stop", "Hanuman Nagar Circle","NCC ground","Rail nagar", "Sadashiv Nagar Last Stop", "Channamma Circle", "Bogarves", "Congress Road", "KLS GIT"],
  m730_b6:  ["KLS GIT", "Ganapati Temple", "Vijayanagar 2nd Stop", "Hindalga Jail", "Sulaga", "Uchagoan Cross", "Kranti Nagar", "Ganeshpur", "Pipeline", "Vinayak Nagar", "KLS GIT"],
  ...
  m730_b10: ["KLS GIT", "Marihal", "Modaga", "Anand Nagar", "Pant Balekundari", "Honnalli", "Balekundri", "Sambra", "Mutaga", "Niliji", "Shindoli", "Basavan Kudachi", "SC Motors", "Gandhi Nagar", "KLS GIT"],
  m730_b11: ["KLS GIT", "CBT", "Fort Circle", "RTO", "Chennamma Circle", "Bogarves", "Fish Market", "Gogte Circle", "1st Gate", "2nd Gate", "3rd Gate", "KLS GIT" ],
  ...
  m900_b1:  ["KLS GIT", "GCC Hostel", "Jain PU College", "Imer College", "Yellur Cross", "Vadagoan", "Bharat Nagar", "Khasbhag", "Nath Pai Circle", "Anand Wadi", "Goaves", "RPD Cross","KLS GIT"],
  m900_b2:  ["KLS GIT", "Vadagaon", "Channamma Circle", "CBT", "KLS GIT"],
  m900_b3:  ["KLS GIT", "Surabhi Hotel", "LSA School", "Kanbargi", "Ganesh Circle", "Uday School Stop 0", "Uday school stop 1", "KSCA CRICKET STADIUM", "Harsha hotel", "Janata plot", "Sai mandir", "Shrinagar garden", "Shri nagar stop", "SGBIT", "Kannada Bhavan ", "Ramdev", "Channamma circle", "Bogarves", "KLS GIT"],
  m900_b4:  ["KLS GIT", "Harsha Hotel", "Janata plot", "More Store", "Nandini Dairy", "Sidnal Stop", "Mahantesh Nagar 1st Stop", "Fort lake", "RTO", "Channamma Circle", "Bogarves", "KLS GIT"],
  m900_b5:  ["KLS GIT", "Ganesh Temple", "Kuvempu Nagar", "KLE School", "Sahaydri Nagar", "Kumarswamy Layout", "Hostel","Hanuman Nagar 2nd Stop", "Hanuman Nagar Circle","NCC ground","Rail nagar", "Sadashiv Nagar Last Stop", "Channamma Circle", "Bogarves", "Congress Road", "KLS GIT"],
  m900_b6:  ["KLS GIT", "Ganapati Temple", "Vijayanagar 2nd Stop", "Hindalga Jail", "Sulaga", "Uchagoan Cross", "Kranti Nagar", "Ganeshpur", "Pipeline", "Vinayak Nagar", "KLS GIT"],
  m900_b7:  ["KLS GIT", "Shahapur", "Tukaram Bank", "Goa Ves", "RPD Cross", "KLS GIT"],
  m900_b8:  ["KLS GIT", "Kakati","Honaga","Kakati Police station","Yamnapur", "Indal bridge","Nexa showroom","Visha Dhaba","Shahunagar cross","Basavan temple","Nehru nagar hostel","Shri Laxmi complex", "Channamma Circle", "KLS GIT"],
  m900_b9:  ["KLS GIT", "Ladies Hostel", "City Hall", "Allahabad Bank", "Netra Group", "Chidambar Nagar 1at Stop", "Mandar Hotel", "Hari Mandir", "Big Bazar", "Banko", "KLS GIT"],
  m900_b10: ["KLS GIT", "Marihal", "Modaga", "Anand Nagar", "Pant Balekundari", "Honnalli", "Balekundri", "Sambra", "Mutaga", "Niliji", "Shindoli", "Basavan Kudachi", "SC Motors", "Gandhi Nagar", "KLS GIT"],
  m900_b11: ["KLS GIT", "CBT", "Fort Circle", "RTO", "Chennamma Circle", "Bogarves", "Fish Market", "Gogte Circle","1st Gate", "2nd Gate", "3rd Gate", "KLS GIT" ],
  ...
  m900_b13: ["KLS GIT", "Shahu Nagar", "Nehru Nagar", "Camp", "Congress Road", "KLS GIT"],
  m900_b14: ["KLS GIT", "Khanapur Old Bus Stop", "Khanapur New Bus Stop", "Jamboti Cross", "Court", "Idalonda", "Prabhu Nagar", "Desur", "BCM Macche", "Macche", "Phirwadi Naka", "Brahma Nagar", "Jitu Hostel", "KLS GIT"],
